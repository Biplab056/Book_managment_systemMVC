...
<form:form action="saveuserAdmin" modelAttribute="user">
 <div class="mb-3">
    <form:label for="exampleInputName1"  path="name" class="form-label">Name</form:label>
    <form:input type="text" path="name" class="form-control" id="exampleInputName1"/>
  </div>
  <div class="mb-3">
  ...
  <button type="submit" class="btn btn-custom btn-dark">Register</button>
</form:form>
