   ...
   <a class="navbar-brand" href="#"> <i class="fa-solid fa-book-open"></i> BookManagmentSystem</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item me-5">
          <a class="nav-link" href="displayBook">Books</a>
        </li>
         <li class="nav-item me-5">
          <a class="nav-link" href="addbook">AddBooks</a>
        </li>
         <li class="nav-item me-5">
          <a class="nav-link" href="SigninUserAdmin">AddUser</a>
        </li>
        <li class="nav-item me-5">
          <a class="nav-link" href="displayUser">Users</a>
        </li>
         <li class="nav-item me-5">
