...
<div class="container p-5 ">
	<div class="row">		
			...
			<div class="card paint-card">
				<div class="card-body">
						<p class="fs-4 text-center">Book Update</p>
						
						 
						  
<form:form action="update" modelAttribute="book">
<div class="mb-3">
    <form:label for="exampleInputName1"  path="id" class="form-label">Book Id</form:label>
    <form:input type="text" path="id" class="form-control" id="exampleInputName1"/>
  </div>
 <div class="mb-3">
  ...
  <button type="submit" class="btn btn-custom btn-dark">Update</button>
</form:form>
